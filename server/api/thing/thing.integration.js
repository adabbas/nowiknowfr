...
describe('Subscriber API:', function() {
  ...
  describe('POST /api/things', function() {
    ...
    it('should respond with the newly created thing', function() {
      newThing.name.should.equal('New Subscriber');
  ...
  describe('GET /api/things/:id', function() {
    ...
    it('should respond with the requested thing', function() {
      thing.name.should.equal('New Subscriber');
  ...
  describe('PUT /api/things/:id', function() {
    ...
    it('should respond with the original thing', function() {
      updatedThing.name.should.equal('New Subscriber');
    ...
    it('should respond with the updated thing on a subsequent GET', function(done) {
      request(app)
        ...
        .end((err, res) => {
          ...
          thing.name.should.equal('Updated Subscriber');
  ...
  describe('PATCH /api/things/:id', function() {
    ...
    beforeEach(function(done) {
      request(app)
        ...
        .send([
          { op: 'replace', path: '/name', value: 'Patched Subscriber' },
    ...
    it('should respond with the patched thing', function() {
      patchedThing.name.should.equal('Patched Subscriber');
