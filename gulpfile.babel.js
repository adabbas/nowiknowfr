...
const paths = {
    client: {
        ...
        po: `${clientPath}/assets/po/**/*`,
        translations: `${clientPath}/assets/translations/**/*`,
...
gulp.task('pot', function () {
  return gulp.src(paths.client.views)
    ...
    .pipe(gulp.dest(`${paths.dist}/${clientPath}/assets/po`));
});

gulp.task('translations', function () {
  return gulp.src(`${paths.dist}/${clientPath}/assets/po`)
    .pipe(gettext.compile({
      // options to pass to angular-gettext-tools...
      format: 'json'
    }))
    .pipe(gulp.dest('${paths.dist}/${clientPath}/assets/translations'));
});
